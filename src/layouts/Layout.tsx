...
const Layout = () => {
  ...
  const hideBottomBar = isSplash || isLogin || isCertification || isCertificationGuide || isCertificationShoot || isCertificationSuccess || isDisposalInfo || isImageSearch || isCertificationFail || isProblemSearch;
