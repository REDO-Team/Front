    ...
    <div className='h-full'>
      ...
      <div className='flex flex-col h-full px-5'>
        ...
        <div className='w-full flex flex-col gap-2.5 mt-auto'>
          ...
          <button type='button' className='font-pretendard font-bold text-lg text-white rounded-4xl bg-main-green1 px-5 py-4 w-full flex items-center justify-center' onClick={() => navigate('/certification')}>
            가이드대로 배출 후 인증
          </button>
        </div>
