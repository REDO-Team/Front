...
export default function CertificationPage() {
  ...
  return (
    <div className='flex flex-col items-center pt-10.5 px-6.5 bg-bg-green1 min-h-screen'>
      ...
      <div className='w-full px-6.5 py-4.5 bg-white mt-15 flex flex-col gap-4'>
      ...
      <div className='flex flex-col w-full gap-2.5 mt-18 mb-5'>
