...
function PartnerPurchaseSection({
  ...
  if (!shippingAddress) {
    return (
      ...
      >
        ...
        <span className='ml-3 text-sm font-bold text-text'>
          배송 정보 입력하기
        </span>
        <span
          aria-hidden='true'
          className='ml-auto text-[30px] font-light leading-none text-main-green1'
        >
          +
        </span>
      </button>
  ...
  return (
    <section className='mt-3 flex min-h-17 items-center rounded-[22px] bg-white px-5 py-4 shadow-[0_6px_16px_rgba(0,0,0,0.04)]'>
      ...
      <button
        type='button'
        className='ml-3 shrink-0 text-xs font-semibold text-main-green1'
      >
        변경
      </button>
    </section>
    ...
    <div className='flex flex-1 flex-col bg-bg-green1 px-5 pb-6 pt-4 font-pretendard'>
      ...
      <div className='mt-3 flex min-h-27 items-center gap-4 rounded-[28px] bg-white px-5 py-[18px]'>
        ...
        <div className='min-w-0 flex-1'>
          ...
          <h2 className='mt-2 truncate text-base font-bold leading-tight text-text'>
            {product.name}
          </h2>
          ...
          <div className='mt-2 flex items-center gap-1.5'>
            ...
            <span className='text-base font-semibold text-main-green1'>
            ...
            <div className='flex w-full justify-between'>
                ...
                <span
                  className={`text-lg font-bold ${
                    remainingPoint < 0 ? 'text-red-500' : 'text-main-green1'
                  }`}
                >
